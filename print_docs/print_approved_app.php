...
$pdf->SetFont('dejavusans', '', 10);
		...
		**/
		...
		$html ='<table cellspacing="0" cellpadding="1" border="0" align="center">
			<tr style="bottom-border:1 solid;">
				<td align="Left" style="font-size:8;font-weight:bold;color:blue"> REPORT LIST OF ALL APPROVED FIRS APPLICATION</td> 
			</tr>
		</table><hr>';
		...
		if($affected_rows_in >= 1) 
		{
			 $html1 .= '<thead style="background-color:none;color:blue">
				...
				$j=1;$data="";
					...
					<tr >
						<td colspan="6" align="center" ><h5 style="color:red">You have Approved - '.$j.' - FIRS Application </h5></td>
					</tr></tbody></table>';
...
$pdf->Output('All_Approved_Application.pdf', 'I');
//============================================================+
// END OF FILE
//============================================================+
