...
define ('K_PATH_IMAGES', '../settings/images/');
...
/**
 * Default main font size. the header and footer font size
 */
define ('PDF_FONT_SIZE_MAIN', 5);

/**
 * Default data font name. font writting specify
 */
define ('PDF_FONT_NAME_DATA', 'helvetica');

/**
 * Default data font size. the font size of the write up
 */
