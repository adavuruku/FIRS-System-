...
//student details
	...
	if($affected_rows_in >= 1) 
	{
		...
		if($affected_rows_in >= 1) 
		{
			...
			$date500 = new DateTime($row_ret_two['dateApprove']);
			$J = date_format($date500,"D");
			$Q = date_format($date500,"d-F-Y, h:i:s A");
			$dateprint_V = $J.", ".$Q;
			$da_ = $J.", ".$Q;
		...
		$html ='<table cellspacing="0" cellpadding="1" border="0" align="center">
				<tr style="bottom-border:1 solid;">
					<td align="justify" colspan ="6" style="font-size:8;">
						<p><b>We hereby Approved Your FIRS Application, which was submitted on '.$d_.' for '.$n_.'</b><br/>Congratulations!!!</p>
						<p style="color:red"><b>Signed: FIRS Management.</b></p>
						<p style="color:red"><b>'.$da_.'</b></p>
					</td>
				</tr>
			</table><hr>';
		$pdf->writeHTML($html, true, false, false, false, '');
...
$pdf->SetAlpha(1);
	...
	$html ='<table border="0" class="table table-condensed table-bordered">
		<tbody>
			<tr>
				<td width="50px">1.</td>
				<td width="590px"><p style="color:black;">This Slip is an Approval Slip Of Your FIRS Application.</p></td>
			</tr>
			<tr>
				<td>2.</td>
				<td><p style="color:black;">Note: Always Login To Your Portal to Print Your Application and Keep for Reference Purpose.</p></td>
			</tr>
			<tr>
				<td>3.</td>
	...
	$pdf->writeHTML($html, true, false, false, false, '');	
$file_name = str_replace(" ","_",$full_name).'_Approval_Slip';
