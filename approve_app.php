...
<div class="container-fluid" >
	...
	<div class="row" >
			...
			<div class="col-xs-12 col-sm-12 col-md-9 col-lg-9" style="margin-bottom:10px;margin-top:5px;text-align:centre;padding-top:5px">
				...
				<h4 style="margin-bottom:10px;background-color:#CCCCFF;padding:10px">ALL APPROVED FIRS APPLICATION AS AT - <?php echo $dateprint;?></h4>
					<?php
							...
							if($affected_rows_in >= 1) 
							{
								...
								<a class="text-right" style="text-decoration:none;color:black;" target="_blank" href=print_docs/print_approved_app.php?m_=oprt&l_w=tueq><h4><span class="glyphicon glyphicon-print" style="cursor:pointer;text-align:center;font-weight:900;padding:5px;"></span>Print List</h4></a>
								...
								echo $data.'</tbody></table><a class="text-right" style="text-decoration:none;color:black;" target="_blank" href=print_docs/print_approved_app.php?m_=oprt&l_w=tueq> <h4><span class="glyphicon glyphicon-print" style="cursor:pointer;text-align:center;font-weight:900;padding:5px;"></span>Print List</h4></a>';
							}else{
								echo '<div class="alert alert-info alert-dismissable">
										   <button type="button" class="close" data-dismiss="alert" 
											  aria-hidden="true">
											  &times;
										   </button><h3>There is no FIRS Application Approved Yet.</h3></div>';
							}
